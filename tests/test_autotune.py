...
class TestTuneProfile:
    ...
    def test_all_fields_present(self):
        ...
        expected_keys = {
            ...
            "gpu_available", "gpu_gflops", "gpu_backend",
            "gpu_dedicated_vram_gb", "gpu_shared_vram_gb", "gpu_total_vram_gb",
            "gpu_vulkan_version", "gpu_is_discrete",
            "gpu_architecture", "gpu_cuda_capability", "gpu_cuda_cores",
            "gpu_tensor_cores", "gpu_rt_cores", "gpu_has_tensor",
            "gpu_has_raytracing", "gpu_has_hw_encode", "gpu_has_hw_decode",
            "gpu_memory_type", "gpu_memory_bandwidth_gbps",
            "gpu_boost_clock_mhz", "gpu_driver_version", "gpu_pcie_gen",
            "gpu_power_limit_w", "gpu_features",
            "optimal_io_workers",
